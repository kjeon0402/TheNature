...
<div class="total_wrap">
	<div class="cw_wrap">
		<div class="cww_wrap">
			...
			<form method="POST" enctype="multipart/form-data" id="ar_regist_form">
					...
					<table class="cwf_table">
						<tbody class="cwf_tbody">
							<tr class="cwf_tr">
								...
								<td class="td_td"><div class="td_div"><input type="text" class="title" name="title" placeholder="종류를 입력해주세요."></div></td>
							</tr>
							<tr class="cwf_tr">
				...
				<div class="btn_div">
					<input class="save_btn" type="submit" value="등록" onclick="arWriteCheck(event);">
					<input class="list_btn" type="button" value="목록" onclick="location.href = '${root}/admin/ar_list'">
				</div>
			</form>
		</div>
	</div>
...
<script>
	...
	function arWriteCheck(event) {
		...
		if(title == '') {
			...
			alert('AR을 등록합니다.')
			document.getElementById('ar_regist_form').submit()
		}
	}
</script>
</html>