					...
					<table class="cwf_table">
						<tbody class="cwf_tbody">
							<tr class="cwf_tr">
								...
								<td class="td_td"><div class="td_div"><input type="text" class="title" name="title" value="${taVO.title }" placeholder="종류를 입력해주세요."></div></td>
							</tr>
							<tr class="cwf_tr">
								...
								<td class="td_td">
									<div class="td_div">
										...
										현재 업로드된 파일 : <span class="span_file">${taVO.ar_path }</span>
										<script>
											function showfile() {
