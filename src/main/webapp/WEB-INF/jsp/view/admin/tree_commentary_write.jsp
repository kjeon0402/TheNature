...
<div class="total_wrap">
	<div class="cw_wrap">
		<div class="cww_wrap">
			...
			<form method="POST" enctype="multipart/form-data" id="commentary_post">
					...
					<table class="cwf_table">
						<tbody class="cwf_tbody">
							<tr class="cwf_tr">
								...
								<td class="td_td"><div class="td_div"><input type="text" class="tree_name" name="tree_name" placeholder="이름을 입력해주세요."></div></td>
								<td class="th_td">영문<span style="color: red;">*</span></td>
								<td class="td_td"><div class="td_div"><input type="text" class="tree_name_english" name="tree_name_english" placeholder="이름(영문)을 입력해주세요."></div></td>
								<td class="th_td">학명<span style="color: red;">*</span></td>
								<td class="td_td"><div class="td_div"><input type="text" class="tree_name_scientific" name="tree_name_scientific" placeholder="학명을 입력해주세요."></div></td>
							</tr>
							<tr class="cwf_tr">
								<td class="th_td">계<span style="color: red;">*</span></td>
								<td class="td_td"><div class="td_div"><input type="text" class="tree_kind01" name="tree_kind01" placeholder="계를 입력해주세요."></div></td>
								<td class="th_td">문<span style="color: red;">*</span></td>
								<td class="td_td"><div class="td_div"><input type="text" class="tree_kind02" name="tree_kind02" placeholder="문을 입력해주세요."></div></td>
								<td class="th_td">강<span style="color: red;">*</span></td>
								<td class="td_td"><div class="td_div"><input type="text" class="tree_kind03" name="tree_kind03" placeholder="강을 입력해주세요."></div></td>
							</tr>
							<tr class="cwf_tr">
								<td class="th_td">목<span style="color: red;">*</span></td>
								<td class="td_td"><div class="td_div"><input type="text" class="tree_kind04" name="tree_kind04" placeholder="목을 입력해주세요."></div></td>
								<td class="th_td">분포지역<span style="color: red;">*</span></td>
								<td class="td_td"><div class="td_div"><input type="text" class="tree_locate" name="tree_locate" placeholder="분포지역을 입력해주세요."></div></td>
								<td class="th_td">크기<span style="color: red;">*</span></td>
								<td class="td_td"><div class="td_div"><input type="text" class="tree_size" name="tree_size" placeholder="크기를 입력해주세요."></div></td>
							</tr>
							<tr class="cwf_tr">
								<td class="th_td">상세설명<span style="color: red;">*</span></td>
								<td class="td_td" colspan="5">
									<div class="td_div">
										<textarea class="td_textarea" name="content" placeholder="상세설명을 입력해주세요."></textarea>
									</div>
								</td>
							</tr>
							<tr class="cwf_tr">
								...
								<td class="td_td" colspan="5">
									<div class="td_div">
										<input type="file" class="tc_thumnail" name="tc_thumnail" accept="image/*" onchange="showfile1()">
							...
							<tr class="cwf_tr">
								...
								<td class="td_td" colspan="5">
									<div class="td_div">
										<input type="file" name="tc_audio" accept="audio/*" class="tc_audio" onchange="showfile2()">
										현재 업로드된 파일 : <span class="span_file2"></span>
<!-- 										<button id="clear_file2" onclick="clearFile(event)">-</button> -->
										<script>
...
// 											}
							...
							<tr class="cwf_tr">
								<td class="th_td">이미지<span style="color: red;">*</span></td>
								<td class="td_td" colspan="5">
									<div class="td_div" style="padding: 0;">
										<div class="dd_div drop-zone">
											<span>Drag & Drop 으로 이미지를 끌어올려주세요.<br>(3개씩만 첨부 가능합니다.)</span>
										</div>
										<div class="dd_icon_div">
											<label>
												<input type="file" id="file" name="tc_image" class="tc_image" accept="image/*" multiple="multiple" onchange="fileCountLimit();">
				...
				<div class="btn_div">
					<input class="save_btn" type="submit" value="저장" onclick="neccessaryCheck(event)">
...
<script>
	...
	function neccessaryCheck(event) {
		...
		var image = document.querySelector('.tc_image').value
		...
		if(name == '' || nameEnglish == '' || nameScientific == '' || treeKind1 == '' || treeKind2 == '' ||
			...
			alert('이미지를 첨부해야합니다. 이미지는 3개만 첨부할 수 있습니다.')
			return
		} else {
			alert('나무 해설이 등록되었습니다.')
			document.getElementById('commentary_post').submit()	
		}
	}
</script>
</html>