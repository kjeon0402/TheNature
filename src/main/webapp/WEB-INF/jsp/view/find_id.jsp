	...
	<div class="fi_wrap">
		...
		<div class="fi_input_div2">
			<div class="fi_input_email">
				<input type="text" name="e_id" id="e_id" placeholder="이메일">@<input id="e_domain" name="e_domain" type="text" placeholder="직접입력">
			</div>
			...
			<div class="btn_certification" id="do_certification" onclick="emailCheck(find_id_form, '${root}');">인증</div>
			<script>
		...
		<div class="fi_btn_div">
			<input type="submit" value="아이디 찾기" onclick="findSubmitCheck()">
		</div>
		</form>

		<div class="fi_bot">
			<span><a href="${root }/find_pw">비밀번호 찾기</a></span>
